...
export const RecordRunPage = () => {
  ...
  useEffect(() => {
    if (testMode && isRunning && !isPaused) {
      // Simulate movement around the default position
      testIntervalRef.current = setInterval(() => {
        setPosition((prevPos) => {
          const newPos = [
            prevPos[0] + (Math.random() - 0.5) * 0.001, // Random small change in lat
            prevPos[1] + (Math.random() - 0.5) * 0.001  // Random small change in lng
          ];
          if (lastPosition.current) {
            ...
            if (dist > 0.0005) { // ~50cm threshold for test
      ...
      <div className="h-screen flex flex-col">
        ...
        <div className="flex-1 relative">
          ...
          >
            ...
            {path.length > 1 && <Polyline positions={path} color="#FF6B00" weight={4} />}
          </MapContainer>
        ...
        <div className="bg-[#0A0E1A] border-t border-white/[0.06] p-6">
          <div className="text-center mb-6">
            ...
            <div className="grid grid-cols-4 gap-3">
              ...
              <div className="glass-card p-3 text-center">
                <div className="text-xl md:text-2xl font-bold text-white">
                  {distance > 0 && time > 0 ? ((distance / (time / 3600))).toFixed(1) : "0.0"}
                </div>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            >
              {testMode ? "Test Mode: ON" : "Test Mode: OFF (Simulate Movement)"}
            </button>
          </div>
        </div>
      </div>
